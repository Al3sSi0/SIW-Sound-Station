...
export function GestioneArtistiPage() {
  const navigate = useNavigate();
  const { isAdmin } = useAuth();

  
  const adminBlocks = [
    { label: 'INSERISCI ARTISTA', color: '#b1e5ba', path: '/admin/artista/new' },
    { label: 'MODIFICA ARTISTA', color: '#d4efe2', path: '/admin/artista/modifica' },
    { label: 'ELIMINA ARTISTA', color: '#8cc0a7', path: '/admin/artista/elimina' },
  ];
