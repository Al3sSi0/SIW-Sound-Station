...
export function GestioneBraniPage() {
  const navigate = useNavigate();
  const { isAdmin } = useAuth();

  
  const adminBlocks = [
    { label: 'INSERISCI BRANO', color: '#b1e5ba', path: '/admin/brano/new' },
    { label: 'MODIFICA BRANO', color: '#d4efe2', path: '/admin/brano/modifica' },
    { label: 'ELIMINA BRANO', color: '#8cc0a7', path: '/admin/brano/elimina' },
  ];
